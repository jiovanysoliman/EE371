...
add wave -noupdate -group {status signals from datapath} /memoryGame_tb/dut/cntrl/seq_num
add wave -noupdate -group {status signals from datapath} /memoryGame_tb/dut/cntrl/show_counter_zero
add wave -noupdate -group {status signals from datapath} /memoryGame_tb/dut/cntrl/full_input
add wave -noupdate -group {status signals from datapath} /memoryGame_tb/dut/cntrl/no_lives
add wave -noupdate -group {status signals from datapath} /memoryGame_tb/dut/cntrl/match
add wave -noupdate -group {status signals from datapath} /memoryGame_tb/dut/cntrl/clk_zero
add wave -noupdate -group {status signals from datapath} /memoryGame_tb/dut/cntrl/key_pressed
add wave -noupdate -group {status signals from datapath} /memoryGame_tb/dut/cntrl/seq_end
add wave -noupdate -group {status signals from datapath} /memoryGame_tb/dut/dp/seq_num
...
add wave -noupdate -group clock -radix unsigned /memoryGame_tb/dut/dp/divClocks
add wave -noupdate -group clock -radix unsigned /memoryGame_tb/dut/dp/clk_select
add wave -noupdate -group clock /memoryGame_tb/dut/dp/reset_clk
add wave -noupdate -group clock /memoryGame_tb/dut/dp/decr_clk
add wave -noupdate -group clock /memoryGame_tb/dut/dp/clk_zero
add wave -noupdate -group clock /memoryGame_tb/dut/dp/next_clk
...
WaveRestoreCursors {{Cursor 1} {5096 ps} 0}
...
update
WaveRestoreZoom {113 ps} {5899 ps}
